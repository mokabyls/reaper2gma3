...
const messages = {
    ...
    "app.locale": { fr: "Changer la langue", en: "Change language" },
    ...
    "action.backToReview": { fr: "Retour au récapitulatif", en: "Back to summary" },
    "stage.settingsGroup": { fr: "Réglage", en: "Setting" },
    ...
    "project.create.inherited": { fr: "Réglages repris de", en: "Settings carried over from" },
    "project.namePlaceholder": { fr: "Nom du show", en: "Show name" },
    ...
    "sequences.manual": { fr: "Numéros de séquence manuels", en: "Manual sequence numbers" },
    "sequences.manualHelp": { fr: "Par défaut les séquences se suivent à partir du premier numéro. Vous pouvez en placer une ailleurs dans le DataPool sans déplacer les autres.", en: "By default sequences follow on from the first number. You can place one elsewhere in the DataPool without moving the others." },
    "sequences.manualTitle": { fr: "Numéros dans le DataPool", en: "DataPool numbers" },
    "sequences.manualHint": { fr: "Saisissez un numéro pour fixer une séquence. Vide = numérotation automatique, affichée en filigrane.", en: "Type a number to pin a sequence. Empty = automatic numbering, shown as the placeholder." },
    "sequences.manualNumber": { fr: "Numéro de séquence", en: "Sequence number" },
    "sequences.manualConflict": { fr: "Numéro réclamé par plusieurs séquences :", en: "Number claimed by more than one sequence:" },
    ...
    "executors.manual": { fr: "Adresses manuelles", en: "Manual addresses" },
    "executors.manualHelp": { fr: "Fixez l’adresse d’une séquence au format page.slot, par exemple 2.250. Une adresse fixée est réservée : les séquences automatiques se rangent autour sans jamais la prendre. Laissez vide pour revenir au placement automatique.", en: "Pin a sequence address in page.slot form, for example 2.250. A pinned address is reserved: automatic sequences pack around it and never take it. Leave empty to return to automatic placement." },
    "executors.manualHint": { fr: "Saisissez une adresse au format page.slot pour la fixer. Vide = placement automatique.", en: "Type an address in page.slot form to pin it. Empty = automatic placement." },
    "executors.manualAddress": { fr: "Adresse d’executor", en: "Executor address" },
    "executors.manualAuto": { fr: "Auto", en: "Auto" },
    "executors.manualConflict": { fr: "Adresse réclamée par plusieurs séquences :", en: "Address claimed by more than one sequence:" },
    ...
    "review.consoleHint": { fr: "Le ZIP s’importe dans grandMA3 comme bibliothèque de macros, puis le macro construit le show.", en: "The ZIP is imported into grandMA3 as a macro library, then the macro builds the show." },
    "review.consoleLink": { fr: "Voir les étapes côté console", en: "See the steps on the console" },
    "review.executorDetail": { fr: "Voir chaque séquence et son adresse d’executor", en: "See each sequence and its executor address" },
    "summary.title": { fr: "Réglages avancés", en: "Advanced settings" },
    "summary.copy": { fr: "Les valeurs par défaut conviennent à la plupart des shows. Chaque section dit ce qu’elle contrôle et ce que vos réglages produiront.", en: "The defaults suit most shows. Each section states what it controls and what your settings will produce." },
    "summary.cuesRegionsWhat": { fr: "Numérotation des cues et traitement des bornes de région.", en: "Cue numbering and how region boundaries are handled." },
    "summary.sequencesWhat": { fr: "Plage de numéros, noms et Speed Master des séquences créées.", en: "Number range, names and Speed Master of the created sequences." },
    "summary.outputWhat": { fr: "Contenu du ZIP et calage du timecode entrant.", en: "What the ZIP contains and how incoming timecode is aligned." },
    "summary.executorsWhat": { fr: "Où les séquences atterrissent sur la console.", en: "Where the sequences land on the console." },
    "summary.extrasWhat": { fr: "Bibliothèques de macros ajoutées au même ZIP.", en: "Macro libraries added to the same ZIP." },
